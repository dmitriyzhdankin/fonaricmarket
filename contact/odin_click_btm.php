...
$error = "";
$name = " - заказ в один клик с сайта FONARIK-MARKET.RU";
...
if(!$error)
{
$subject ="Обратная связь посадочная страница Санкт-Петербург";
...
{
echo '<div class="notification_error_btm">'.$error.'</div>';
}
}
?>
<?php $con=mysql_connect("193.0.61.200","fonarik_fonarik2","221976");
		  ...
		  $sql = "SELECT * FROM wp_posts AS p 
					...
					LEFT JOIN wp_terms AS t ON t.slug = 'fonarikua_rus'
		  ...
		  $rsd = mysql_query($sql);// || die(mysql_error());
		  ...
		  $test .= '<li><a href="'.str_replace("fonarikua.code201.net","fonarik-market.ru",$menu_meta['_menu_item_url']).'">'.$menu_item['post_title'];
